    ...
    <div>
      ...
      >
        <div className="w-100vw h-100vh   bg-white/60 bg-cover   backdrop-blur-[0px] absolute inset-0 left-5 top-5 bottom-5 right-5">
          <div>
            <h4 className="justify-self-center pt-10 font-mono text-[16px] md:text-[24px]">
              Riverbank media
            </h4>
            <h1 className="justify-self-center font-mono text-[35px] md:text-[45px] flex content-center font-bold pt-55">
              M25RB
            </h1>
          </div>
          <div className="content-end pt-30">
            ...
            <h4 className="font-mono pt-2 j justify-self-center md:text-[17px]">
              VIEW GALLERY
            </h4>
          </div>
        </div>
